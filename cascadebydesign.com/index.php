...
<head>
    ...
    <meta name="description" content="Here at Cascade Design, we believe in simple and minimalist designs that get the point across, but without all the bulk. Fill out the contact form to get a quote on your project. We offer general graphic design and web design services. ">
    <meta name="author" content="Ryan Harper">
    ...
    <section id="designer" class="designer">
        <div class="container">
            <div class="row">
                ...
                <p class="designer-info color-light">Hello, My name is Ryan. I am the lead designer at Cascade Design. I have been accomplishing aesthetically pleasing design for a total of five years now and specifically web design for three. In my free time, I enjoy walking around locally and filming nature. Living in Colorado, it is hard to be so close to the mountains and restrain myself from filming in locations among the high country. Over my years of work, I have seen my fair share of terribly designed webpages, logos, and photography that does not match the subject. I started Cascade Design to add to the movement to simplify the web. My outlook is that a company's webpage should be a reflection of the type of work that they do. A trustworthy site is the first step to achieving that goal; through great design and photography. </p>
                <br>
