...
<head>
    ...
    <![endif]-->
    <?php
  $bg = array('/res/img/bg.jpg', '/res/img/bg1.jpg', '/res/img/bg2.jpg', '/res/img/bg3.jpg', '/res/img/bg4.jpg', '/res/img/bg5.jpg');
...
?>
        <style type="text/css">
            intro {
                background: url(images/<?php echo $selectedBg; ?>) no-repeat bottom center scroll;
            }
        </style>
        <!-- *** Contact ONLY Form -->
        <?php
